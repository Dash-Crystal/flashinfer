...
| H200 sm90 XQA, q=4 (SPEC_DEC, runs mha.cu) | 135 | <= 94 | <= 59 | <= 101 | FP8 231, FP4 277, mixed 437 (co-tenant-corrected; after [29]: 198/240/420; after [40]: 198 / 236 / 216; after [41][42] (2 CTAs/SM, M tile 16, 680 CTAs): A16 99.7, FP8 124.3, FP4 144.3, mixed 137.8; after [43] (128 B K parts, rolled tile loops, one copy body): A16 86.1, FP8 114.0, FP4 115.9, mixed 116.1; **after [44] (placement decode + owner-cut expansion + hoisted copy constants): A16 86.4, FP8 116.7, FP4 103.6, mixed 110.3** — A16 passes; FP8 / FP4 / mixed at 1.24x / 1.76x / 1.09x of target; executed instructions 0.84x / 0.72x / 0.82x but issue-active fell 52 -> 43 % (fp8) — the kernel is latency-bound on the per-span scale chain / vote and on K/V landing (long scoreboard), not on instruction count; see backends.md "Track S step 6") |

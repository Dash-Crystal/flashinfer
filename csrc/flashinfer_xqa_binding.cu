...
void xqa_wrapper(bool run_sm90_fp8_mha, int64_t multiProcessorCount, int64_t nbKHeads,
                 ...
                 tvm::ffi::Optional<TensorView> vSfCacheVLLM,
                 tvm::ffi::Optional<TensorView> fp8KPayload,
                 tvm::ffi::Optional<TensorView> fp8VPayload,
                 tvm::ffi::Optional<TensorView> fp8KScales,
                 tvm::ffi::Optional<TensorView> fp8VScales,
                 tvm::ffi::Optional<TensorView> fp4KPayload,
                 tvm::ffi::Optional<TensorView> fp4VPayload,
                 tvm::ffi::Optional<TensorView> fp4KScales,
                 tvm::ffi::Optional<TensorView> fp4VScales,
                 tvm::ffi::Optional<TensorView> pageFormat,
                 tvm::ffi::Optional<TensorView> fp8KGlobalScale,
                 tvm::ffi::Optional<TensorView> fp8VGlobalScale,
                 tvm::ffi::Optional<TensorView> fp4KGlobalScale,
                 tvm::ffi::Optional<TensorView> fp4VGlobalScale, TensorView kvCachePageList,
                 int64_t maxSeqLen, TensorView seqLen, int64_t batchSize, double kvCacheScale,

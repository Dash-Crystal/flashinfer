...
Runs the 32 register-expansion cases, the 2 native block-FP8 cases, the 18
tail / value-range cases (short and odd sequence tails, 35-tile CTAs, E4M3
subnormal payloads and maximal block scales) and the 2 independent-reference
cases (mixed A16 stream vs stock decode) on sm90 / sm12x.  Exit code is the
